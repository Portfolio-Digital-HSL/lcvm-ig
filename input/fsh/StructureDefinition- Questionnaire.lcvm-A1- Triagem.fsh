...
// Deficiencia - Possui algum tipo de deficiencia 
...
// Tipo Deficiencia (Select all that apply)
...
* item[=].item[=].enableWhen[0].question = "LCVM.A1.DE014"
* item[=].item[=].enableWhen[0].operator = #="
* item[=].item[=].enableWhen[0].answer = "Y"


// ============================================================
// SEÇÃO 1 — TIPO DE VIOLÊNCIA (DE0001 - DE1E - 
// ============================================================
* item[+].linkId  = "LCVM.A1.Secao1"
* item[=].text    = "Seção 1 — Tipo de Violência"
* item[=].type    = #group

// LCVM.A1.DE12 — Afirmativas (Select all that apply)
...
* item[=].item[=].extension[=].valueExpression.description = "Somar os pontos de cada uma das respostas à pergunta LCVM.A1.DE12"
* item[=].item[=].extension[=].valueExpression.expression  = "%resource.item.where(linkId='LCVM.A1.DE12').answer.valueCoding.extension.where(url='http://hl7.org/fhir/StructureDefinition/ordinalValue').value.aggregate($total + $this, 0)"
